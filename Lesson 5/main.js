...
// console.log(dueDate +' '+ subject+ " " + assignTo);
...
//     }
//     else{
//         let newKeywoud=prompt(`We could not find your keyword:${keyword},leave your explantion `);
//         alert('Done');
//         dictionary[keyword]=newKeywoud;
//     }
// }
...
// let i=0;
// for(let value of products){
//     value.provider=providers[i++];
//     console.log('..............................')
//     console.log(`Name:${value.name} \n Price:${value.price} \n Provider:${value.provider} `) ;
// }

// let user=prompt('Enter provider');
// for(let value of products){
//     console.log('..............................');
//     if(value.provider.includes(user)==true){
...
//     {name:'Basic of Js',Complete:'false'},
//     {name:'Node Packeage Manager',Complete:'false'},
//     {name:'Git',Complete:'false'},
// ];

// for(let key in learningTask){
//     console.log(`${Number(key)+1} ${learningTask[key].name} \n Complete:${learningTask[key].Complete}`);
// }

// while(true){
//     let user=prompt('Enter your command(New,Delete,Update,Complete)').toLowerCase();
//     if(user=='new'){
//         let newLearning = prompt('Enter new task');
//         let newLearningTaks={name:newLearning , Complete:'false'};
//         learningTask.push(newLearningTaks);
//         for(let key in learningTask){
//             console.log(`${Number(key)+1} ${learningTask[key].name} \n Complete:${learningTask[key].Complete}`);
//         }
...
//         let newLearningUpdate = prompt('Enter new task');
//         let newLearningTaksUpdate={name:newLearningUpdate , Complete:'false'};
//         learningTask.splice(position-1,0,newLearningTaksUpdate);
//         for(let key in learningTask){
//             console.log(`${Number(key)+1} ${learningTask[key].name} \n Complete:${learningTask[key].Complete}`);
//         }
...
//         let positionC=Number (prompt("Enter position: "));
//         for(let key in learningTask){
//             if(key==positionC-1){
//                 learningTask[key].Complete='true';
//             }
//             console.log(`${Number(key)+1} ${learningTask[key].name} \n Complete:${learningTask[key].Complete}`);
//         }
...
//     }
//     else if(user=='delete'){
//         let positionD=Number (prompt("Enter position: "));
//         learningTask.splice(positionD-1,1);
//         for(let key in learningTask){
//             console.log(`${Number(key)+1} ${learningTask[key].name} \n Complete:${learningTask[key].Complete}`);
//         }
...
// //3------15.............................
// //the data type of the outermost layer:Object
// //Hit là array chứa các object
// //3....... Cách tìm jobTitle
// var jobHit = {
//     hits: [
//         {
...
// for(let value of jobHit.hits){
//     console.log(value.jobTitle);
// }
// let firstJob=jobHit.hits[0]
// console.log(firstJob);

// let firstTitle=jobHit.hits[0].jobTitle;
// console.log(firstTitle);

// let firstBenefits=jobHit.hits[0].benefits;
// console.log(firstBenefits);


// for(let value of firstBenefits){
...
// for(let value of jobHit.hits){
//     let arr2=[];
//     for(value1 of value.benefits){
//         arr2.push(value1.benefitValue);
//     }
//     let object={JobTile:value.jobTitle,Benefits:arr2};
//     arr.push(object);
// }
